...
;; (require 'init-uml)
;REMOVE - too advanced to be useful - (require 'init-sunrise-commander)
(require 'init-bbdb)
(require 'init-gnus)
(require 'init-smarter-compile)
(require 'init-twittering-mode)
;REMOVE (require 'init-weibo)
...
;REMOVE (require 'init-move-window-buffer)
